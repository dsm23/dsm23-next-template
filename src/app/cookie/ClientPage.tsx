  ...
  <main className="container grid">
    <div className="cols-12 cols-m-8">
      ...
      <P>
        ...
        carts, and payment processing. These cookies are necessary for the Sites
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                of our Sites by downloading and installing a browser plugin
                available{" "}
      ...
      <P>
        ...
        Browser web storage enables the storage of a larger amount of data than
      ...
      <P>
        ...
        about your use of our Sites. Unlike other cookies, Flash cookies cannot
        be removed or rejected via your browser settings. If you do not want
        Flash LSOs stored on your computer or mobile device, you can adjust the
        settings of your Flash player to block Flash LSO storage using the tools
        contained in the Website Storage Settings Panel. You can also control
        Flash LSOs by going to the Global Storage Settings Panel and following
        the instructions. Please note that setting the Flash Player to restrict
        or limit acceptance of Flash LSOs may reduce or impede the functionality
      ...
      <P>
        ...
        inconvenience in your use of our Sites. For example, we may not be able
      ...
      <P>
        ...
        or at any time by visiting the cookie preferences below. Our cookie
        banner and cookie preference center allow you to accept, refuse or
        manage the setting of all or some cookies:
      </P>
      <ul>
        <li>Strictly necessary cookies do not require your consent.</li>
        <li>
          When we deploy other cookies, you have the possibility to either
          accept or reject all cookies, or to allow the deployment of the
          categories of cookies you prefer, by clicking on the appropriate
      ...
      <P>
        ...
        <a href="https://optout.aboutads.info/?c=2&lang=EN">here</a>. Please
        note that we also may work with companies that offer their own opt-out
        mechanisms and may not participate in the opt-out mechanisms linked
        above.
      </P>
      <P>
        If you do not accept our cookies, you may experience some inconvenience
        in your use of our Sites. For example, we may not be able to recognize
    ...
    <div className="cols-16 cols-m-8">
      ...
      <P>
        ...
        the use of cookies may impact your overall experience with our site and
        the services we can offer. By clicking the ENABLED button, you provide
        your consent to our use of all categories of cookies on our site.
        Similarly, by clicking the DISABLED button, you choose to restrict our
        use of cookies during your visit.
      </P>
      {/* <FormComponent>
        <RadioGroup
